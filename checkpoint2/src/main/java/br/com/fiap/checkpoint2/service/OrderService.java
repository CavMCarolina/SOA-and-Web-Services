...
public class OrderService {
    ...
    public OrderModel readOrderByID(Long id) throws EntityNotFoundException {
        return orderRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("Pedido com ID " + id + " não foi encontrado."));
    }

    public OrderModel updateOrder(Long id, OrderModel order) throws EntityNotFoundException {
        return orderRepository.findById(id)
                .map(existingOrder -> {
